---
title: "About Bordeaux Performance Repertoire (1784-1793)"
output:
  html_document:
    includes:
...
knitr::include_graphics("../site/images/Spectacles.png")
```
...
knitr::include_graphics("../site/images/processed_ad.png")
```
...
knitr::include_graphics("../site/images/dataframe.png")
```
